...
function(summary_variable,
    ...
    if (length(population_strata_proportions) != uniqueN(sample_data[['STRATA_VARIABLE']])) population_strata_proportions <- population_strata_proportions[unique(sample_data[['STRATA_VARIABLE']])]
