...
function(
	...
	if ("PDF" %in% gap_plot_output_format) {
		...
		figure.vp <- viewport(layout = grid.layout(3, 3, widths = unit(c(0.8, 9.5, 2.7)*fig_width/13, rep("inches", 3)),
							  heights = unit(c(0.2, 7.6, 0.8)*fig_height/8.5, rep("inches", 3))),
							  gp=gpar(cex=fig_width/13))
